...
function App() {
  return (
    <Routes>
      ...
      <Route path="/people/:id" element={<RequireAuth><ProfileScreen /></RequireAuth>} />
      <Route path="/people" element={<RequireAuth><ProfileScreen /></RequireAuth>} />
      ...
      <Route path="/admin/audit" element={<RequireAuth><AuditScreen /></RequireAuth>} />
